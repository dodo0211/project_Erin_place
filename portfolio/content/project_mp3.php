        ...
        <div>
            ...
            <div class="portfolio_content">
                ...
                <div class="portfolio_img_android">
                    <div><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/project_erin_place/portfolio/img/project_mp3/mp3_1.png" alt="프로젝트mp3_결과사진1"></div>
                    <div><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/project_erin_place/portfolio/img/project_mp3/mp3_2.png" alt="프로젝트mp3_결과사진2"></div>
                    <div><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/project_erin_place/portfolio/img/project_mp3/mp3_3.png" alt="프로젝트mp3_결과사진3"></div>
                    <div><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/project_erin_place/portfolio/img/project_mp3/mp3_4.png" alt="프로젝트mp3_결과사진4"></div>
                </div><br />
            </div>
        </div>
