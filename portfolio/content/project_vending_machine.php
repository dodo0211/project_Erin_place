        ...
        <div>
            ...
            <div class="portfolio_content">
                ...
                <div class="portfolio_img">
                    <div><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/project_erin_place/portfolio/img/project_vending_machine/vending_machine1.png" alt="프로젝트vending_machine_결과사진1"></div>
                    <div><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/project_erin_place/portfolio/img/project_vending_machine/vending_machine2.png" alt="프로젝트vending_machine_결과사진2"></div>
                    <div><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/project_erin_place/portfolio/img/project_vending_machine/vending_machine3.png" alt="프로젝트vending_machine_결과사진3"></div>
                    <div><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/project_erin_place/portfolio/img/project_vending_machine/vending_machine4.png" alt="프로젝트vending_machine_결과사진4"></div>
                </div><br />
            </div>
        </div>
